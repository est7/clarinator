...
const EN: Strings = {
  ...
  handoffTitle: "Sent to the agent",
  handoffBody: "Keep this tab open. The agent will either ask more questions or close this session.",
...
const ZH: Strings = {
  ...
  handoffTitle: "已提交给 agent",
  handoffBody: "先不要关这个标签页。agent 会决定继续提问还是关闭这个流程。",
